    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supabase_uid', models.CharField(blank=True, db_index=True, max_length=255, null=True, unique=True)),
                ('email', models.EmailField(db_index=True, max_length=254, unique=True)),
                ('full_name', models.CharField(blank=True, max_length=255)),
                ('role', models.CharField(choices=[('SHOPKEEPER', 'Shopkeeper'), ('RIDER', 'Rider'), ('WAREHOUSE_MANAGER', 'Warehouse Manager'), ('ADMIN', 'Admin')], default='SHOPKEEPER', max_length=20)),
