...
class OrderCreationTestCase(APITestCase):
    ...
    def test_order_creation_success(self):
        ...
        response = self.client.post('/api/orders/shopkeeper/orders/create/', data, format='json')
    ...
    def test_order_creation_duplicate_pending_order(self):
        ...
        response1 = self.client.post('/api/orders/shopkeeper/orders/create/', data, format='json')
        self.assertEqual(response1.status_code, status.HTTP_201_CREATED)

        # Try to create second order
        response2 = self.client.post('/api/orders/shopkeeper/orders/create/', data, format='json')
    ...
    def test_order_creation_wrong_warehouse_items(self):
        ...
        data = {
            ...
            "items": [
                {"item_id": self.item1.id, "quantity": 5}  # Item belongs to different warehouse
            ]
        }
