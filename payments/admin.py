...
class PaymentAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'id', 'transaction_id', 'payment_type', 'status', 'amount',
        'payer', 'payee', 'rider', 'warehouse', 'order',
    ...
    fieldsets = (
        ('Transaction Information', {
            'fields': ('transaction_id', 'payment_type', 'status', 'amount', 'payment_method')
        }),
        ('Related Entities', {
            'fields': ('order', 'warehouse', 'payer', 'payee', 'rider')
        }),
        ('Additional Details', {
            'fields': ('distance_km', 'notes')
        }),
        ('Timestamps', {
