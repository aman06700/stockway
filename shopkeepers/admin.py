...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Info", {"fields": ("user", "notification_type")}),
        ("Content", {"fields": ("title", "message", "order")}),
...
class SupportTicketAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Info", {"fields": ("user", "category", "priority")}),
        ("Ticket Details", {"fields": ("subject", "description", "order")}),
        ("Status & Resolution", {"fields": ("status", "admin_notes", "resolved_at")}),
