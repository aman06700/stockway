...
urlpatterns = [
    ...
    path(
        ...
        ShopkeeperOrderUpdateView.as_view(),
        name="order-update",
    ),
    path(
        "orders/<int:pk>/tracking/",
        ShopkeeperOrderTrackingView.as_view(),
        name="order-tracking",
    ),
    # Payment Records
    ...
    path(
        "payments/summary/",
        ShopkeeperPaymentSummaryView.as_view(),
        name="payment-summary",
    ),
    # Inventory Browsing
    path(
        "inventory/browse/",
        ShopkeeperInventoryBrowseView.as_view(),
        name="inventory-browse",
    ),
    path(
        "warehouses/nearby/",
        ShopkeeperNearbyWarehousesView.as_view(),
        name="warehouses-nearby",
    ),
    # Notifications
    path(
        "notifications/",
        ShopkeeperNotificationListView.as_view(),
        name="notification-list",
    ),
    path(
        "notifications/mark-read/",
        ShopkeeperNotificationMarkReadView.as_view(),
        name="notification-mark-read",
    ),
    path(
        "notifications/unread-count/",
        ShopkeeperNotificationUnreadCountView.as_view(),
        name="notification-unread-count",
    ),
    # Support/Feedback
    path(
        "support/tickets/",
        ShopkeeperSupportTicketListView.as_view(),
        name="support-ticket-list",
    ),
    path(
        "support/tickets/create/",
        ShopkeeperSupportTicketCreateView.as_view(),
        name="support-ticket-create",
    ),
    path(
        "support/tickets/<int:pk>/",
        ShopkeeperSupportTicketDetailView.as_view(),
